...
- [ ] **P6-150 — Exercise real scenarios and remediate the beta.**
  ...
  making the intended live-association guard exercise artificial in a healthy
  single-root graph. The customer guide no longer manipulates state or breaks
  that dependency merely to manufacture an external association: Step 8 now
